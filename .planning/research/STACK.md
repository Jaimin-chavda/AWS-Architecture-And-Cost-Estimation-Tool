...
**Domain:** AWS deployment-diagram generator + cost estimator webapp (LLM inference → draw.io diagram → AWS Price List API cost estimate). Low-traffic university project.
**Researched:** 2026-08-07
**Confidence:** HIGH for core stack; per-item confidence noted below. All versions verified against npm registry / official docs on this date (Context7 unavailable in this environment — versions verified directly against registry.npmjs.org and official docs instead).
...
# Core
npm install ai@^7.0.56 zod@^4.4.3 @ai-sdk/deepseek@^3.0.24 @ai-sdk/google@^4.0.37 @ai-sdk/groq@^4.0.24
npm install @aws-sdk/client-pricing@^3.1105.0
npm install better-auth@^1.6.26 better-sqlite3@^12.11.1
...
**If DeepSeek is unavailable / budget is strictly $0:**
...
**If Gemini free-tier quota is tight (quotas were cut Dec 2025 and shifted Apr 2026):**
- Make DeepSeek the primary (it is, above). DeepSeek charges pennies; a demo's worth of calls is cents.

**If the demo must work fully offline / air-gapped:**
...
**If GitHub unauthenticated limits (60 req/hr) are hit during the demo:**
...
*Stack research for: AWS Architect (AWS deployment diagram + cost estimator webapp)*
*Researched: 2026-08-07*
